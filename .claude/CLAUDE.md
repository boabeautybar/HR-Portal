...
## IMPORTANT: Codebase Intelligence Instructions for HR-Portal-Employee-Data-Library
...
Last indexed: 2026-07-06 (commit 22a2d3e)
### Entry Points
...
|------|-------|-------------|-------|
| `app.jsx` | 95.5th %ile | 386 | Claude |
| `kiosk/staff-app.js` | 90.9th %ile | 37 | Claude |
| `kiosk/manager-app.js` | 86.4th %ile | 36 | Claude |
| `data.js` | 81.8th %ile | 48 | Claude |
| `kiosk/data.js` | 77.3th %ile | 28 | Claude |
...
Defect risk, Hotspot health: 3.48/10 (stable) ·
Average: 7.14/10 ·
Worst: 2.34/10 (`kiosk/staff-app.js`)
Maintainability, Average: 7.73/10
Performance risk, Average: 9.85/10

### Critical biomarkers
- `kiosk/manager-app.js` — prior defect — impact −2.0
- `kiosk/staff-app.js` — prior defect — impact −1.6
- `data.js` — large method (<anonymous>) — impact −1.5
- `kiosk/data.js` — large method (<anonymous>) — impact −1.5
- `kiosk/manager-app.js` — large method (<anonymous>) — impact −1.5
