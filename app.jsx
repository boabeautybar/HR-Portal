...
function App({ currentUser, onSignOut, appUsers, onUsersUpdate }) {
  ...
  const NAV_TAB_TO_CATEGORY = {
    onboard:"People", offboard:"People", staff:"People", recruitment:"People", hrLibrary:"People", maternity:"People",
  ...
  const salonData = useMemo(() => SALONS.map(salon => {
    ...
    return { ...salon, all, active, onMat, offboarded, arriving, provisional, urgency, goal };
  }), [enriched, obList]);
