...
(function () {
  ...
  function render() {
    ...
    root.innerHTML = [
      ...
      '<div class="note">',
        '<div class="lead">Please only call in if you genuinely can\'t work — it affects your pay, bonus and schedule.</div>',
        '<details>',
          '<summary>What this means</summary>',
          '<ul>',
            '<li>💸 <b>Techs:</b> no commission on days off, and absences hurt your bonus target.</li>',
            '<li>🏅 <b>Managers:</b> a missed scheduled work day forfeits your attendance bonus.</li>',
            '<li>🔁 <b>No catch-up:</b> you can\'t replace a missed day by working an extra one without regional-manager approval.</li>',
            '<li>📄 <b>Sick leave</b> needs a valid medical certificate to be paid.</li>',
            '<li>⚠️ Repeated absences are monitored and may lead to disciplinary steps.</li>',
          '</ul>',
        '</details>',
      '</div>',
      '<div class="card">',
        ...
        '<label class="ack"><input type="checkbox" id="ack" />',
          '<span>I genuinely can\'t work, and I understand the impact on my pay, bonus and schedule.</span></label>',
